...
```json
{"pid":203939,"cwd":"/home/theconnman/git/theconnman/claude-settings/jobs/0214d552/tmp/ivtest3","kind":"interactive","startedAt":1785063978527,"sessionId":"599bdf0b-6cae-4348-b75c-62af08319e2c","name":"ivtest3-51","status":"idle"}
{"pid":211453,"cwd":"/home/theconnman/git/theconnman/claude-settings/jobs/0214d552/tmp/ivtest4","kind":"interactive","startedAt":1785064081697,"sessionId":"06bbea79-f3dc-4816-a590-f1200fc08fc3","name":"ivtest4-38","status":"idle"}
```

versus a background row from the same call:

```json
{"pid":178698,"id":"7fb47b1b","cwd":"/home/theconnman/git/theconnman/claude-settings/jobs/0214d552/tmp/ivtest","kind":"background","startedAt":1785063825559,"sessionId":"7fb47b1b-5f51-4233-979e-5571b4ba84fd","name":"7fb47b1b","status":"idle","state":"done"}
```
...
▝▜█████▛▘  Opus 5 (1M context) · ~/git/theconnman/claude-settings/jobs/0214d552/tmp/ivtest3
...
`claude agents --cwd /home/theconnman/.claude/jobs/0214d552/tmp/ivtest3`, run while the
...
`ctrl+s` toggles between a cwd-grouped layout (headers like `~/git/curietech/agentos`) and the
