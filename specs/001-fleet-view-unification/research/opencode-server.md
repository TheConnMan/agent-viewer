...
```
  ...
  Build · Qwen3.7 Plus OpenCode Go   ~/git/example-user/claude-settings/jobs/0214d552/tmp/ocprobe
  • OpenCode 1.17.20
```
...
```
/home/example/.cache/opencode/models.json
/home/example/.local/share/opencode/opencode.db{,-wal,-shm}
/home/example/.local/share/opencode/snapshot/global/...
/home/example/.local/share/opencode/log/opencode.log
```
