...
fn scanner_reports_pr_written_into_the_rollout() {
    ...
    append(
        &path,
        &line("created https://github.com/example-org/example-repo/pull/1089"),
    );
...
fn scanner_reads_only_the_appended_bytes() {
    ...
    append(
        &path,
        &line("created https://github.com/example-org/example-repo/pull/1088"),
    );
    ...
    let delta = line("then https://github.com/example-org/example-repo/pull/1089");
    append(&path, &delta);
    let mut budget = SCAN_BUDGET_BYTES;
...
fn scanner_ignores_a_partial_line_until_its_newline_lands() {
    ...
    let full = line("created https://github.com/example-org/example-repo/pull/1089");
...
fn list_populates_pr_refs_from_the_rollout() {
    ...
    append(
        &with_pr,
        &line("opened https://github.com/example-org/example-repo/pull/1089"),
    );
